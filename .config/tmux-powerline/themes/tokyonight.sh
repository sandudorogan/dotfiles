...
TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR=${INACTIVE_BG}
...
if [ -z "$TMUX_POWERLINE_LEFT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
		...
		# "wan_ip 24 255"
		"vcs_branch ${GREEN} ${BG}"
		"vcs_compare ${INACTIVE_BG} ${BLUE}"
		"vcs_staged ${INACTIVE_BG} ${GREEN}"
		"vcs_modified ${INACTIVE_BG} ${YELLOW}"
		#"vcs_others 245 0"
	)
fi
...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		...
		#"xkb_layout 125 117"
		"date_day ${INACTIVE_BG} ${FG}"
		"date ${INACTIVE_BG} ${FG} ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
		"time ${INACTIVE_BG} ${FG} ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
